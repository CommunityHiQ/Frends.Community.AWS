...
#pragma warning restore 1591
    ...
    {
        public static async Task<JObject> ListObjectsAsync(Parameters parameters, Options options, CancellationToken cToken)
        {
            #region Error tests
                ...
                RegionSelection(parameters.Region)))
            {
                var request = new ListObjectsV2Request()
                {
                    ...
                    Delimiter = string.IsNullOrWhiteSpace(parameters.Delimiter) ? null : parameters.Delimiter,
                    ...
                    Prefix = string.IsNullOrWhiteSpace(parameters.Prefix) ? null : parameters.Prefix,
                    ContinuationToken = string.IsNullOrWhiteSpace(parameters.ContinuationToken) ? null : parameters.ContinuationToken,
                    StartAfter = string.IsNullOrWhiteSpace(parameters.StartAfter) ? null : parameters.StartAfter
                };
